            ...
            <form class="row" action="{{url('admin/users/'.$User->id.'/edit')}}" method="POST">
                ...
                <div class="col-md-6 col-12 px-4 pb-3">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" id="firstname" name="firstname" value="{{ $User->firstname}}" pattern=".{2,}" title="Please enter at least 2 characters" placeholder="Enter user's firstname">
                ...
                <div class="col-md-6 col-12 px-4 pb-3">
                  <div class="mb-3">
                    ...
                    <input
                      ...
                      placeholder="Enter user's 10-digit phone number"
                    />
                ...
                <div class="col-12 px-4 pb-1">
                  <div class="mb-3">
                      ...
                      <input class="form-control  map-input" type="text" id="property_address" name="address" value="{{ $User->address}}" pattern=".{10,}" title="Please enter at least 10 characters" placeholder="Enter user's address">
