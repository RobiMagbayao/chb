...
<section id="contact" class="nav-margin">
    <div class="container">
      <div class="row my-auto">
        ...
        >
          <div class="h5 mb-2 fw-bold">Solar Panel Cleaning Inclusions</div>
          <div>
            <ul>
              <li>Thorough cleaning of solar panels</li>
            </ul>
          </div>
          <div class="h5 mt-4 mb-2 fw-bold">Pricing</div>
          <div>
            Our pricing for solar panel cleaning services is personalized
            based on the specific details of your property. We prioritize
            delivering exceptional service with clear and competitive rates.
          </div>
        ...
        >
        <form action="{{ url('solar_cleaning/'.$quote->id.'/edit') }}" method="POST"  enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="visually-hidden">
                <input type="text" name="service_type" value="Solar Panel Cleaning">
                @error('service_type')
