...
<section id="contact" class="nav-margin">
    <div class="container">
      <div class="row my-auto">
        ...
        >
          <div class="h5 mb-2 fw-bold">Gutter Guard Installation Inclusions</div>
          <div>
            <ul>
              <li>Installation of high-grade gutter guard</li>
          ...
          <div>
            Our pricing for gutter installation services is personalized based
            on the specific details of your property. We prioritize delivering
        ...
        >
        <form action="{{ url('gutter_guard_installation') }}" method="POST"  enctype="multipart/form-data">
            @csrf
           
            <div class="visually-hidden">
              <input type="text" name="service_type" value="Gutter Guard Installation">
              @error('service_type')
